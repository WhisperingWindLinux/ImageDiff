#include "recentfilespresenter.h"

// Converts a QPair<QString, QString> to a formatted QString
QString RecentFilesPresenter::pairToString(const QPair<QString, QString>& pair) {
...
std::optional<QPair<QString, QString>> RecentFilesPresenter::stringToPair(const QString& str) {
...
std::optional<QPair<QString, QString>> RecentFilesPresenter::splitString(const QString& str, const QString& separator) {
